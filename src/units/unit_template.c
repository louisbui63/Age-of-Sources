...
//! The first text is the name of the unit. It must not be more to 255
//! characters long.
/*Name*/
...
//! decimal integer smaller or equal to 65535
/*32*/
...
//! The thirteenth text is the unit's sprite path, it must be less to 255
//! characters long.
/*asset/sprites/tanuki_maid.bmp*/

//! The fourtennth text is the unit's description, it must be less to 1024
//! characters long.
/*description*/
